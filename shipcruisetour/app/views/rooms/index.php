...
<div class="tab-content" id="nav-tabContent">
  ...
  <div class="col-ml-6">
      <a class="btn btn-primary pull-right" href="<?php echo URLROOT; ?>/rooms/add"><i class="fa fa-pencil" aria-hidden="true"></i> Add room</a>
    </div>
  ...
  <tbody class="text-center">
    <tr>
      ...
      <td><?php echo $room->shipnom; ?></td>
      <td><?php echo $room->roomtype; ?></td>
      <td>  <a class="btn btn-dark" href="<?php echo URLROOT; ?>/rooms/show/<?php echo $room->id; ?>">More</a>
</td>
   </tr>
  </tbody>
  <?php endforeach; ?>
